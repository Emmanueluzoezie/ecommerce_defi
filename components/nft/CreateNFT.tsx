...
import { addItemAndSaveNft } from '../../utiies/storage';
                ...
                <div className='flex flex-col mt-10'>
                  <form className='space-y-4 max-w-[500px] p-4 shadow-2xl rounded-2xl'>
                    ...
                    <div>
                      ...
                      <textarea className="border-2 w-full outline-none border-gray-400 rounded-md p-2" rows={3} onChange={(e) => setSymbol(e.target.value)} />
                    </div>
                    <div>
