...
const AllAddedProduct = () => {
    ...
    const withdrawSOL = async() => {
        ...
        try {
            ...
            if (!fromPubkey) {
                // Handle the case when wallet.publicKey is null
                throw new Error("Wallet public key is null");
            }

            // Get the fee payer's public key (it can be the same as fromPubkey or a different account)
                  ...
                  <div className='flex justify-center w-full'>
                      <div className='bg-white w-[300px] p-4 shadow-2xl rounded-md'>
                          ...
                          <div className='space-y-6 mt-6'>
                              <button className='text-center text-lg font-semibold border-[4px] py-1 rounded-md w-full border-[#4d07b0] text-[#4d07b0] hover:bg-[#4d07b0] hover:text-white'>Pay with QR code</button>
